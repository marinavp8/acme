error id: file://<WORKSPACE>/src/main/scala/com/acme/service/AcmeService.scala:`<none>`.
...
class AcmeService(
  ...
  def this() = this("acme://letsencrypt.org/staging", "keys")
  ...
  def createCertificate(domain: String): Try[CertificateResult] = Try {
    ...
    authorizations.foreach { auth =>
      ...
      val challenge = auth.findChallenge(Http01Challenge.TYPE).asInstanceOf[Http01Challenge]
      ...
      if (challenge != null) {
        ...
        // In a real scenario, you would set up the HTTP server here
